        ...
        <form class="account w-100" id="miClave" style="display: none;">
            ...
            <div class="account-edit">
                <div class="container mt-3 mb-3">
                    <div class="row w-100 mr-0 ml-0">
                        <div class="input-group col">
                            <input class="form-control" id="claveVieja" name="claveVieja" type="password" placeholder="Ingrese su antigua contraseña">
                        </div>
                    </div>
                </div>
            </div>
            <div class="account-edit">
                <div class="container mb-3">
                    <div class="row w-100 mr-0 ml-0">
                        <div class="input-group col">
                            <input type="password" class="form-control" id="claveNueva" name="claveNueva" placeholder="Ingrese su nueva contraseña">
                        </div>
                    </div>
                </div>
            </div>
            <div class="account-edit">
                <div class="container mb-3">
                    <div class="row w-100 mr-0 ml-0">
                        <div class="input-group col">
                            <input type="password" class="form-control" id="claveNuevaConf" name="claveNuevaConf" placeholder="Confirme su nueva contraseña">
                        </div>
                    </div>
                </div>
            </div>
